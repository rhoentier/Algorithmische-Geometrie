...
\lstset{basicstyle=\small, language=C, keywordstyle=\color{black},commentstyle=\color{gray}, numbers=left, numberstyle=\tiny}
...
\begin{figure}[h]
    \subfloat[]{\includegraphics[width=0.30\textwidth]{./Abbildungen/1a.png}}
    \subfloat[]{\includegraphics[width=0.30\textwidth]{./Abbildungen/1b.png}}
    \qquad
    \subfloat[]{\includegraphics[width=0.30\textwidth]{./Abbildungen/1c.png}}
    \subfloat[]{\includegraphics[width=0.30\textwidth]{./Abbildungen/1d.png}}
    \centering
    \caption{Zerlegung eines konvexen Polygons $CP$ in vier konvexe Polygone $CP_{1},...,CP_{4}$}
    \label{erstes beispiel}
\end{figure}

%Wenn Beispiel in eienr Zeile abgebildet werden soll
%\begin{figure}[h]
%    \subfloat[]{\includegraphics[width=0.20\textwidth]{./Abbildungen/1a.png}}
%    \subfloat[]{\includegraphics[width=0.20\textwidth]{./Abbildungen/1b.png}}
%    \subfloat[]{\includegraphics[width=0.20\textwidth]{./Abbildungen/1c.png}}
%    \subfloat[]{\includegraphics[width=0.20\textwidth]{./Abbildungen/1d.png}}
%    \centering
%    \caption{Zerlegung eines konvexen Polygons $CP$ in vier konvexe Polygone $CP_{1},...,CP_{4}$}
%    \label{erstes beispiel}
%\end{figure}
...
Diese Vorgehensweise entspricht im Wesentlichen Fall 1, wobei \ls (initialisiert mit $w_{1}$) nun nicht im Uhrzeigersinn zum ersten Standort \s{1}, sondern gegen den Uhrzeigersinn zum letzten Standort \s{n} bewegt wird. Vergleiche auch Abbildung~\ref{zweites beispiel}, Fall (c) und (i).
\begin{figure}[h]
...
\begin{figure}[h]
    ...
    \centering
    \caption{Beispiel einer Aufteilung eines nicht konvexen Polygons, entnommen aus XX Abbildung 17}
